...
// 정적으로 인스턴스가 만들어지는 시점에 this가 결정됨! 변경X
...
dog.printName(); // 다른 객체지향 프로그래밍 언어에서는 고양이의 this이기 때문에 고양이 이름이 나옴
cat.printName();
...
printOnMonitor(cat.printName); // undefined -> 함수를 호출하는 객체가 없으므로
